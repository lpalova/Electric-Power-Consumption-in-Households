...
The variation in the active energy is 21 Wh per minute and 17 Wh per minute on average during weekends and weekdays, respectively.
The global reactive energy is small, `r round(mean(recorded_df$reactive_power*1000/60.0), 1)` Wh per minute on average,
leading to average shift factor of 0.96.
Notice that distributions (viz. histogram or boxplot) of active power, reactive power and shift factor are skewed.
The variation is also large for all three measured quantities. 
Further analysis is needed to address the short- and long-term variability.

Please see figures and pdf at:
https://github.com/lpalova/Electric-Power-Consumption-in-Households
